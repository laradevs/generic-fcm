<?php
namespace LaraDevs\PhpFirebaseCloudMessaging;

use LaraDevs\PhpFirebaseCloudMessaging\Recipient\Recipient;
...
class Message implements \JsonSerializable
{
     ...
     *
     * @return \LaraDevs\PhpFirebaseCloudMessaging\Message
     */
